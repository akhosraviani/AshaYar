...
private final Map<String,Object> moreExtras = new HashMap<String,Object>(3);
    ...
    /**
153    * @param activity {@link Activity} invoking the integration
154    */
...
/**
162    * @param fragment {@link Fragment} invoking the integration.
163    *  {@link #startActivityForResult(Intent, int)} will be called on the {@link Fragment} instead
164    *  of an {@link Activity}
165    */
...
253    *
254    * @return the {@link AlertDialog} that was shown to the user prompting them to download the app
...
265    * @return the {@link AlertDialog} that was shown to the user prompting them to download the app
...
278    * @return the {@link AlertDialog} that was shown to the user prompting them to download the app
...
292    * @return the {@link AlertDialog} that was shown to the user prompting them to download the app
