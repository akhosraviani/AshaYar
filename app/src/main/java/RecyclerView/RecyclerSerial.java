 ...
 */
public class RecyclerSerial extends RecyclerView.Adapter<RecyclerSerial.VH> {
    ...
    public RecyclerSerial(Context context,List<InformationRow> informationRows,OnItemClickListener listener){
